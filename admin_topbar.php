...
<style>
    .admin-topbar { background:#ffffff; padding:15px 30px; margin:-20px -20px 30px -20px; border-bottom:1px solid #e0e0e0; display:flex; justify-content:space-between; align-items:center; box-shadow:0 2px 5px rgba(0,0,0,0.03); }
